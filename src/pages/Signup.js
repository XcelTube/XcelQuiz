...
const Signup = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-900 overflow-hidden relative">
        ...
        <motion.div 
          ...
          className="max-w-md w-full bg-gray-800 bg-opacity-80 backdrop-blur-lg p-8 rounded-xl shadow-2xl border border-gray-700 relative z-10 text-center"
        >
          <motion.div
            animate={{ 
              y: [0, -10, 0],
          ...
          >
            <div className="w-24 h-24 bg-blue-900 rounded-full flex items-center justify-center mx-auto">
              <FaRocket className="text-4xl text-blue-400 animate-pulse" />
            </div>
          </motion.div>
          
          <h2 className="text-3xl font-bold text-white mb-4">Launch Successful!</h2>
          <p className="text-gray-400 mb-8">Your XcelQuiz account has been created. Prepare for takeoff!</p>
          ...
          >
            <Link 
              to="/login" 
              className="inline-block w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 px-6 rounded-lg font-medium hover:from-blue-600 hover:to-purple-700 transition-all duration-200 shadow-lg"
            >
              Begin Your Journey
            </Link>
          </motion.div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 overflow-hidden relative">
      ...
      {/* Nebula effect */}
      <div className="absolute -left-1/4 -top-1/4 w-1/2 h-1/2 bg-blue-900 rounded-full filter blur-[100px] opacity-20"></div>
      <div className="absolute -right-1/4 -bottom-1/4 w-1/2 h-1/2 bg-purple-900 rounded-full filter blur-[100px] opacity-20"></div>

      <motion.div 
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
        className="max-w-md w-full bg-gray-800 bg-opacity-80 backdrop-blur-lg p-8 rounded-xl shadow-2xl border border-gray-700 relative z-10"
      >
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-white mb-2">Join XcelQuiz</h2>
          <p className="text-gray-400">Embark on your knowledge journey</p>
        </motion.div>
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          >
            <div className={`absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none 
              ${activeInput === 'name' ? 'text-blue-400' : 'text-gray-500'}`}>
              <FaUser />
            </div>
            <input
              type="text"
              ...
              className={`w-full pl-10 pr-3 py-3 bg-gray-700 border ${errors.name ? 'border-red-500' : 'border-gray-600'} rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-white placeholder-gray-400 transition-all duration-200`}
          ...
          >
            <div className={`absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none 
              ${activeInput === 'confirmPassword' ? 'text-blue-400' : 'text-gray-500'}`}>
              <FaLock />
            </div>
            <input
              type={showPassword ? "text" : "password"}
              ...
              onBlur={() => setActiveInput(null)}
              className={`w-full pl-10 pr-3 py-3 bg-gray-700 border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-600'} rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-white placeholder-gray-400 transition-all duration-200`}
              placeholder="••••••••"
            />
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-gray-800 text-gray-400">Or warp in with</span>
            </div>
          </div>
